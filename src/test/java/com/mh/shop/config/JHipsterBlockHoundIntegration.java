...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("com.mh.shop.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("com.mh.shop.security.DomainUserDetailsService", "createSpringSecurityUser");
